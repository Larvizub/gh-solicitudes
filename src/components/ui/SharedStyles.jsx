...
import { gradients } from './sharedStyles.constants';

// ═══════════════════════════════════════════════════════════════════════════════
// COMPONENTES UI COMPARTIDOS - Estilo visual coherente
// Las constantes (gradients, tableStyles, dialogStyles) están en sharedStyles.constants.js
// ═══════════════════════════════════════════════════════════════════════════════
...
// NOTA: Las constantes gradients, tableStyles, dialogStyles se importan desde:
// import { gradients, tableStyles, dialogStyles } from '@/components/ui/sharedStyles.constants'
